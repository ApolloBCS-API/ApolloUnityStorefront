...
public class GlobalSettings : MonoBehaviour {
	...
	public static GlobalSettings Instance {
		get{
			if(_instance == null) {
				GameObject gSettings = GameObject.Find ("Apollo_Settings") as GameObject;
				if(gSettings == null) {
					gSettings = GameObject.Instantiate(Resources.Load ("Prefabs/Apollo_Settings")) as GameObject;
				}
